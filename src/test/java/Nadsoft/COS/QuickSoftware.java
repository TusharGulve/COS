...
//*		
		driver.get("https://nadqatestcompany13thnov.contractorestimatepro.com");
		Thread.sleep(8000);
...
//*		
		driver.findElement(By.id("ctl00_txtUserName")).sendKeys("nadqatestcompany13thnov");   // Enter Username
		Thread.sleep(1000);
	...
	public void addCustomer()throws InterruptedException
	{
		...
		driver.findElement(By.cssSelector("#ctl00_txtPhone")).click();
		driver.findElement(By.cssSelector("#ctl00_txtPhone")).sendKeys("(976) 664-8949"); // Enter Customer Phone
		Thread.sleep(500);
	...
	public void addAppointment() throws InterruptedException
	{
		...
		driver.findElement(By.id("btnAddAppointment")).click();  // Click on Add Appointment Button
		Thread.sleep(5000);
		...
		Thread.sleep(500);
//*		
		driver.findElement(By.id("ctl00_txtStartDateTime")).sendKeys("12/08/2017 10:30 PM");  // Enter Event Start Date
		Thread.sleep(500);
//*		
		driver.findElement(By.id("ctl00_txtEndDateTime")).sendKeys("12/08/2017 11:30 PM");  // Enter Event End Date
		Thread.sleep(500);
...
public void addPhotos() throws InterruptedException, AWTException
	...
	public void addFile() throws InterruptedException, AWTException
	{
		...
		// Specify the file location with extension
		StringSelection sel = new StringSelection("/home/nadsoft1/Pictures/Actual.png");
